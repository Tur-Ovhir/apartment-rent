...
export default function ApartmentIdPage() {
  ...
  const handleCreateContract = () => {
    ...
    localStorage.setItem("contractId", id ? id.toString() : "1");
              ...
              <div className="space-y-1 mt-2 ">
                <Dialog>
                  <DialogTrigger asChild>
                    <Button className="w-40 cursor-pointer text-lg text-white border border-[#434FAA] bg-[#7065F0] ">
                      ХОЛБОГДОХ
                    </Button>
                  </DialogTrigger>
                  <DialogContent>
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button className="w-40 cursor-pointer  text-[#434FAA] border  bg-white border-[#434FAA] ">
                      МЕССЕЖ ИЛГЭЭХ
                    </Button>
                  </DialogTrigger>
                  <DialogContent>
                ...
                <Button
                  ...
                  className="w-40 cursor-pointer  border  border-black   text-black bg-white"
                >
                  ГЭРЭЭ БАЙГУУЛАХ
                </Button>
              </div>
